...
<div class="title">周辉收款主页</div>
<div class="waiting panelContent">
<img class="qrcode lightBorder" src="/img/id-alipay.png">
<div class="info">
<p class="normlDesc">支付宝账号:Pay@zhouhui.org</p>

<p class="normlDesc">用支付宝客户端扫描二维码以支付</p><p class="errorMsg">成功扫描，请在客户端点击确认以订阅</p>
<br><br><br><br>
<a href="http://www.miitbeian.gov.cn" rel="nofollow" target="_blank" style="color:#8a8a8a">粤ICP备09205380号</a> 
</div>
</div>
</div>
